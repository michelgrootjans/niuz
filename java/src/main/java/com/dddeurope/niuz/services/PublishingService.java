...
public class PublishingService {
    ...
    public PublishingService(AuthorRepository authors, ArticleRepository articles, TeaserRepository teasers, PaymentRepository payments, EventPublisher publisher) {
